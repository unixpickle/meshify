...
class Multiview_Diffusion_Net():
    ...
    def __call__(self, input_images, control_images, camera_info):
        ...
        generator_device = self.pipeline.device.type if self.pipeline.device.type == "cuda" else "cpu"
        ...
        mvd_image = self.pipeline(input_images, num_inference_steps=self.config.multiview_steps, **kwargs).images
